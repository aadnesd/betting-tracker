	...
	return (
		<div className="flex items-center gap-2">
			<AlertDialog>
				...
				<AlertDialogContent>
					<AlertDialogHeader>
						...
						<AlertDialogDescription>
							This will hide the wallet from your active list. The wallet and its
							transactions will be preserved and can be restored later.
						</AlertDialogDescription>
					</AlertDialogHeader>
					<AlertDialogFooter>
			...
			<AlertDialog>
				...
				<AlertDialogContent>
					<AlertDialogHeader>
						<AlertDialogTitle>Permanently delete "{walletName}"?</AlertDialogTitle>
						<AlertDialogDescription>
