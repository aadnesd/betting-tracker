...
export function QuickTransactionSheet({
  ...
  const validateAccountForm = (): boolean => {
    ...
    } else if (accountForm.type === "adjustment" ? amount === 0 : amount <= 0) {
      newErrors.amount =
  ...
  const validateWalletForm = (): boolean => {
    ...
    if (!walletForm.amount || Number.isNaN(amount)) {
      newErrors.amount = "Amount is required";
    } else if (walletForm.type === "adjustment" ? amount === 0 : amount <= 0) {
      newErrors.amount =
        walletForm.type === "adjustment"
          ? "Adjustment amount must be non-zero"
          : "Amount must be positive";
    }
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  id="walletAmount"
                  min={walletForm.type === "adjustment" ? undefined : "0.01"}
