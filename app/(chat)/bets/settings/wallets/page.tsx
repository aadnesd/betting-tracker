...
export default async function WalletSettingsPage() {
  ...
  const cryptoWallets = activeWallets.filter(
    (w) => w.type === "crypto" || w.type === "hybrid"
  );
    ...
    <div className="space-y-6 p-4 md:p-8">
      <div className="flex flex-col items-start justify-between gap-3 md:flex-row md:items-center">
        <div>
          ...
          <p className="text-muted-foreground text-sm">
            Track e-wallets and crypto wallets used to fund your betting
            accounts.
          </p>
        </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <Card>
          ...
          <CardContent>
            <p className="font-bold text-2xl">{totals.walletCount}</p>
          </CardContent>
        </Card>
        <Card>
          <CardHeader className="pb-2">
      ...
      <div className="rounded-lg border border-blue-200 bg-blue-50/50 p-4">
        <h3 className="mb-2 font-medium text-blue-900">
          About Wallet Tracking
        </h3>
        <ul className="space-y-1 text-blue-800 text-sm">
          <li>
            • <strong>Fiat wallets</strong> include e-wallets like Revolut,
            Skrill, PayPal, Neteller
          </li>
          <li>
            • <strong>Crypto wallets</strong> include wallets like Exodus,
            MetaMask, Trust Wallet
          </li>
          <li>
            • Track deposits, withdrawals, and transfers to/from betting
            accounts
          </li>
          <li>
            • Wallet balances are included in your total capital on the Bankroll
            page
          </li>
        </ul>
      </div>
