    ...
    <div className="space-y-6 p-4 md:p-8">
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-muted-foreground text-sm">API v4 — Daily sync</p>
          </CardContent>
        </Card>
        <Card>
          <CardHeader className="pb-2">
      ...
      <div className="rounded-lg border border-blue-200 bg-blue-50/50 p-4">
        ...
        <ul className="space-y-1 text-blue-800 text-sm">
          <li>
            • <strong>Match data</strong> is fetched from football-data.org API
            daily
          </li>
          <li>
            • <strong>Upcoming matches</strong> (next 14 days) allow you to link
          ...
          <li>
            • Selecting fewer competitions reduces API calls and improves
            performance
          </li>
