import { Key, Smartphone, AlertTriangle, ExternalLink } from "lucide-react";
    ...
    <div className="space-y-6 p-4 md:p-8">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Generate an API key to use with iOS Shortcuts. This allows you to submit
            matched bets directly from your phone without opening the web app.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <ApiKeyManager
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <ol className="list-decimal list-inside space-y-3 text-sm">
            ...
            <li>
              <strong>Copy the key</strong> immediately (it won't be shown again)
            </li>
            <li>
            ...
            <li>
              ...
              <ul className="mt-2 ml-6 space-y-1 text-muted-foreground">
                <li>• URL: <code className="rounded bg-muted px-1 py-0.5">https://yoursite.com/api/bets/shortcut</code></li>
                <li>• Method: POST</li>
            ...
            <li>
              <strong>Add image input</strong> using "Select Photos" or share sheet
            </li>
            <li>
              <strong>Parse the response</strong> and show a notification with the result
            </li>
          </ol>
            ...
            <div className="flex items-start gap-2">
              ...
              <div>
                ...
                <p className="text-sm text-amber-800">
                  Your API key provides full access to create bets in your account.
                  Keep it secure and never share it. If you suspect it has been
...
Content-Type: multipart/form-data`}
          ...
          <div>
            <h4 className="font-medium mb-2">Request Body (FormData)</h4>
            <ul className="space-y-1 text-sm text-muted-foreground">
              <li>• <code>back</code> (required): Back bet screenshot (PNG/JPEG, max 10MB)</li>
              <li>• <code>lay</code> (required): Lay bet screenshot (PNG/JPEG, max 10MB)</li>
              <li>• <code>promoType</code> (optional): Promo type string (default: "None")</li>
              <li>• <code>notes</code> (optional): Notes for the bet</li>
            </ul>
          </div>

          <div>
            <h4 className="font-medium mb-2">Response (Success)</h4>
            <pre className="rounded bg-muted p-3 text-sm overflow-x-auto">
{`{
  "success": true,
  "matchedBetId": "uuid",
  ...
  "needsReview": false
          ...
          <div>
            ...
            <ul className="space-y-1 text-sm text-muted-foreground">
              <li>• <code>401 INVALID_API_KEY</code>: Missing or invalid API key</li>
              <li>• <code>429 RATE_LIMITED</code>: Too many requests (wait 10 seconds)</li>
              <li>• <code>400 MISSING_IMAGES</code>: Back or lay image not provided</li>
              <li>• <code>400 INVALID_IMAGE_TYPE</code>: Image must be PNG or JPEG</li>
              <li>• <code>400 IMAGE_TOO_LARGE</code>: Image exceeds 10MB</li>
              <li>• <code>500 PARSE_FAILED</code>: AI parsing failed</li>
            </ul>
          </div>
        </CardContent>
      </Card>
